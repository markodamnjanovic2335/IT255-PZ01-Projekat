System.register(['angular2/core', 'angular2/common', 'angular2/http', 'rxjs/Rx', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            DodajKnjiguComponent = (function () {
                function DodajKnjiguComponent(builder, http, router) {
                    var _this = this;
                    this.select = 1;
                    this.http = http;
                    this.router = router;
                    this.addForm = builder.group({
                        zanr_id: [this.select, common_1.Validators.none],
                        naziv_knjige: ["", common_1.Validators.none],
                        autor: ["", common_1.Validators.none],
            ...
            exports_1("DodajKnjiguComponent", DodajKnjiguComponent);
        }
    }
});
